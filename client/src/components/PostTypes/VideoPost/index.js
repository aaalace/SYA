...
export const VideoPost = ({videoData, setVideoData}) => {
        ...
        <div className='box'>
            ...
            {videoData ? 
                <div className='audio-player-container'>
                    <video className='player-container__content' controls>
                        <source src={videoData}/>
                    </video>
                    <i className="fa-solid fa-trash-can audio-player-trash" onClick={() => {setVideoData(false)}}/>
                </div>
            : null}
        </div>
    )
